class Staff::Dmpd::Stats::ContactCardBoxController < StaffController
  inherit_resources
  ...
  add_breadcrumb 'contact card box',
                 :dmpd_stats_contact_card_box_index_path
  def index
  ...
  def new
    add_breadcrumb 'add',
                   :new_dmpd_stats_contact_card_box_path
  ...
  def edit
    add_breadcrumb 'edit',
                   :edit_dmpd_stats_contact_card_box_path
    super
  end
