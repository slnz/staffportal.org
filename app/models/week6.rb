class Week6 < ActiveRecord::Base
  ...
  has_one :user
  def completed
    if !call_testimony.empty? and !discipleship_story_1.empty? and !discipleship_story_2.empty? and !discipleship_story_3.empty? and listen_to_attitude_message and memorize_prayer_sheet_passage and prayer_sheet and review_how_to_get_contacts_faster_than_you_can_use_them and review_purpose_of_dmpd_training and !salvation_testimony.empty? and share_call_testimony and share_salvation_testimony and !victory_story_1.empty? and !victory_story_2.empty?
      true
    else
      false
    end
