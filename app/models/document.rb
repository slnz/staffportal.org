class Document < ActiveRecord::Base
  ...
  DIRECT_UPLOAD_URL_FORMAT = %r{\Ahttps:\/\/#{Regexp.escape Rails.configuration.aws[:bucket]}\.s3\-us\-west\-2\.amazonaws\.com\/(?<path>uploads\/.+\/(?<filename>.+))\z}.freeze

  belongs_to :user
  has_many :user_assignments, dependent: :nullify
